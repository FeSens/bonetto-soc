// DDR3-800 command plus abstract PHY-timing loopback image for YPCB-00338.
//
// This gate replaces the internal x8 lane memories with ddr3_line_lane_phy and
// a tiny pin-pair memory model. DQ/DQS board pins remain high-Z; the proof here
// is that live JTAG/Wishbone traffic reaches the clean controller, scheduled
// command stream, PHY start pulses, write DQ rise/fall launch, read capture,
// and full-line reassembly boundary.

`default_nettype none

module top_ddr3_ctrl_line_phytimingloop (
    input  wire        SYS_CLK,
    input  wire        SYS_RSTN,
    ...
    top_ddr3_ctrl_line_loopback #(
        ...
        .USE_LINE_TO_LANES(0),
        .USE_LINE_LANE_PHY(1),
        .GATE_VERSION(32'hB07E_0D87),
        .DEFAULT_MAGIC(24'hD3AD87)
    ) u_top (
        .SYS_CLK(SYS_CLK),
        .SYS_RSTN(SYS_RSTN),
