// Formal harness for the minimal single-bank runtime command sequencer.

`default_nettype none
`include "ddr3_params.vh"

module ddr3_single_read_wrapper (
    input wire clk,
    input wire rst
);
