// Formal harness for the init-gated line-level DDR3 controller shell.

`default_nettype none
`include "ddr3_params.vh"

module ddr3_ctrl_line_wrapper (
    input wire clk,
    input wire rst
);
...
`endif
    ...
    wire _unused = &{1'b0, wb_dat_r, init_busy, init_state, refresh_count,
                     bank_busy, bank_open, ddr_cmd_valid, ddr_cs_n,
                     ddr_ras_n, ddr_cas_n, ddr_we_n, ddr_ba, ddr_addr,
                     wr_line_data, wr_line_mask, 1'b0};
endmodule
